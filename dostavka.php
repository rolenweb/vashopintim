...
<meta charset="UTF-8" />
			...
			<title>Доставка интим товаров</title>
			<meta name="description" content="Доставка интим товаров почтой России, в пункты самовывоза." />
			<meta name="keywords" content= "доставка интим товаров" />
			<meta http-equiv="X-UA-Compatible" content="IE=edge">
			<link rel="shortcut icon" href="<? echo $htmlpath;?>image/favicon.png" type="image/x-icon">
			<link href="<? echo $htmlpath;?>/dostavka/" rel="canonical" />
									...
									<div class="product-info">
										...
										<div class="col-md-12">
											<div class="dostavka">
												...
												<ul>
													<li><i class="fa fa-check-square-o"></i> Оплаченные заказы доставляются <span class="up-w">бесплатно</span> при заказе от 990 руб.</li>
													<li><i class="fa fa-check-square-o"></i> Стоимость доставки почтой России фиксирована и составляет 350 руб.</li>
													<li><i class="fa fa-check-square-o"></i> Самовывоз от 190 руб.</li>
												</ul>
												<div class="vazno">
													<h2>Пожалуйста, обратите внимание !!!</h2>
													<p>
														При любом способе доставки и самовывозе вы не взаимодействуете с сотрудниками нашего магазина. Менеджеры транспортной компании, курьеры, которые привозят вам заказ и сотрудники почты не имеют отношения к нашему магазину. <span class="up-w">Они не знают, из какого магазина вы получаете заказ и что находится в упаковке.</span>
													</p>
													<h3>Упаковка всегда закрыта, защищена от несанкционированного вскрытия и не содержит надписей, которые могут указывать на содержимое заказа.</h3>
												</div>	
											</div>
										</div>
										</div>
